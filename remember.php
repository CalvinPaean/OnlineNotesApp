...
//        array_key_exists('user_id', $_SESSION);
        ...
        list($authentificator1, $authentificator2) = explode(',', $_COOKIE['rememberme']);//take a coupe of parameters, the first one is the delimiter, the second is the string to be split.
        ...
        if($count!=1){
            echo "<div class='alert alert-danger'>Remember me proces failed.</div>";
            exit;
        }
        ...
        if(!hash_equals($row['f2authentificator2'], $f2authentificator2)){
            ...
            //store them in the cookie and rememberme table
